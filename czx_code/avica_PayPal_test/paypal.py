...
def log(name,loginfo):
    log_dir = r'C:\Users\admin\Desktop\czx_py_test\avica_PayPal_test\dist\log'
...
def paypal():
    ...
    # I-SJ6SUJGD7EKG
    # driver.get('https://www.paypal.com/webapps/billing/subscriptions?ba_token=BA-46B85027893455121')
    # 等待10秒
    time.sleep(10)
...
def cancelpaypal():
    ...
    # url = "https://console.avica.link/api/trade/subscription/cancel?subscriptionNo=I-YU0E57RT9VBG"
    payload = ""
    headers = {
    'Content-Type': 'application/json',
    'Userkey': AUserkey
    # 'Userkey': 'rsat:kz9TibAHyO6JxHkln2e8akNx6l2'
    }
    response = requests.request("GET", url, headers=headers, data=payload)
    print(response.text)
...
def send_email(status):
    with open(r'C:\Users\admin\Desktop\czx_py_test\avica_PayPal_test\dist\file.txt', 'r' , encoding='utf-8') as file:
        html_template  = file.read()
    # status = 2
    if status ==True:
        result = '成功'
        emial_url = "chenzixin@rayvision.com"
        # emial_url = "zuowangwang@rayvision.com,lindekai@rayvision.com,xiejinshi@rayvision.com,zhouhaiqi@rayvision.com,wangyanli@rayvision.com,gordon@rayvision.com,angelachan@rayvision.com,zhoushuangquan@rayvision.com,chenzixin@rayvision.com,chenzhenqun@rayvision.com,wanduanwei@rayvision.com"
    else:
        result = '失败'
        emial_url = "chengzitest@163.com"
        # emial_url = "zuowangwang@rayvision.com,lindekai@rayvision.com,xiejinshi@rayvision.com,zhouhaiqi@rayvision.com,wangyanli@rayvision.com,chenzixin@rayvision.com,chenzhenqun@rayvision.com,wanduanwei@rayvision.com"
    date = datetime.now()
...
if __name__ == "__main__":
    try:
        ...
        log(type(errorinfo).__name__,errorinfo)
        send_email(False)
